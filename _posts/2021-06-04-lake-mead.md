...
{% include image.html filename="webp/2021-06/009-01.webp" hf=1 %}
{% include image.html filename="webp/2021-06/009-02.webp" hf=1 %}

如果想从高处看Lake Mead那么就导航到一个叫Lake Mead - Lakeview Overlook的地方。

{% include image.html filename="webp/2021-06/009-03.webp" %}
{% include image.html filename="webp/2021-06/009-04.webp" hf=1 %}
{% include image.html filename="webp/2021-06/009-05.webp" hf=1 %}

之后还可以继续参观胡佛大坝。i-11高速专门修了一条给人走的通道以供参观胡佛大坝，可以从人行道走上去，只不过需要爬一小段。

{% include image.html filename="webp/2021-06/009-06.webp" hf=1 %}
{% include image.html filename="webp/2021-06/009-07.webp" hf=1 %}
{% include image.html filename="webp/2021-06/009-09.webp" %}

这里是内华达州于亚利桑那州的交界处，亚利桑那州内大部分地区全年使用山区标准时（MST），所以夏天时与内华达州使用的太平洋夏令时（PDT）没有时差，而冬天则差一小时。

{% include image.html filename="webp/2021-06/009-08.webp" %}
