...
{% include image.html filename="2021-05/001-a.jpeg" %}
...
{% include image.html filename="2021-05/001-b.jpeg" %}

## Day 5 (2021.6.2)
Luke在酒店远程工作一日，我开车前往位于Arizona的[Pipe Spring]({{arr[4]}})，之后疯狂开车，到达[Great Basin]({{arr[5]}})，最终返回St. George酒店。

{% include image.html filename="2021-05/001-c.jpeg" %}
...
{% include image.html filename="2021-05/001-d.jpeg" %}

{% include image.html filename="2021-06/001-e.gif" %}
{% include image.html filename="2021-06/001-f.gif" %}
