...
{% include image.html filename="webp/2021-05/001-a.webp" %}
...
{% include image.html filename="webp/2021-05/001-b.webp" %}

## Day 5 (2021.6.2)
Luke在酒店远程工作一日，我开车前往位于Arizona的[Pipe Spring]({{arr[4]}})，之后疯狂开车，到达[Great Basin]({{arr[5]}})，最终返回St. George酒店。

{% include image.html filename="webp/2021-05/001-c.webp" %}
...
{% include image.html filename="webp/2021-05/001-d.webp" %}

{% include image.html filename="misc/001-e.gif" %}
{% include image.html filename="misc/001-f.gif" %}
