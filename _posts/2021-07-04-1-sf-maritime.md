...
{% include image.html filename="webp/2021-07/011-01.webp" %}

这个小公园分成了好几个部分，疫情的关系我只去了露天的码头，室内的游客中心、博物馆和研究中心统统没去（或者没开门）。

{% include image.html filename="webp/2021-07/011-06.webp" hf=1 %}
{% include image.html filename="webp/2021-07/011-02.webp" hf=1 %}
...
{% include image.html filename="webp/2021-07/011-04.webp" hf=1 %}
{% include image.html filename="webp/2021-07/011-05.webp" hf=1 %}

从海上望过去，不远处就是恶魔岛。

{% include image.html filename="webp/2021-07/011-03.webp" %}

公园里不知道为什么会有一个给你讲利用滑轮省力的装置……

{% include image.html filename="webp/2021-07/011-07.webp" hf=1 %}
{% include image.html filename="webp/2021-07/011-08.webp" hf=1 %}
