...
{% include image.html filename="japan/06-01.jpeg" l=1 %}
{% include image.html filename="japan/06-03.jpeg" r=1 %}
...
{% include image.html filename="japan/06-04.jpeg" l=1 %}
{% include image.html filename="japan/06-05.jpeg" r=1 %}

世界遗产严岛神社。

走到大鸟居跟前。

{% include image.html filename="japan/06-06.jpeg" l=1 %}
{% include image.html filename="japan/06-07.jpeg" r=1 %}

上面写的是“伊都岐岛神社”。

神社参拜入口。

{% include image.html filename="japan/06-08.jpeg" l=1 %}
{% include image.html filename="japan/06-10.jpeg" r=1 %}
...
{% include image.html filename="japan/06-11.jpeg" l=1 %}
{% include image.html filename="japan/06-12.jpeg" r=1 %}

偶遇一对结婚的新人。

可能是一场传统的日式婚礼？

{% include image.html filename="japan/06-13.jpeg" l=1 %}
{% include image.html filename="japan/06-14.jpeg" r=1 %}
...
{% include image.html filename="japan/06-15.jpeg" l=1 %}
{% include image.html filename="japan/06-16.jpeg" r=1 %}

从此开始九州之旅，坐的都是九州铁路公司的车（Kyushu Railway）。

列车内部有类似于吧台的地方，大概是留给没座的乘客，不过这趟车人不太多，人人都有座。

{% include image.html filename="japan/06-17.jpeg" l=1 %}
{% include image.html filename="japan/06-18.jpeg" r=1 %}
...
{% include image.html filename="japan/06-20.jpeg" l=1 %}
{% include image.html filename="japan/06-19.jpeg" r=1 %}
...
{% include image.html filename="japan/06-23.jpeg" l=1 %}
{% include image.html filename="japan/06-24.jpeg" r=1 %}

山上的信号塔，之后还会遇到哦。

远处的女神大桥。

{% include image.html filename="japan/06-26.jpeg" l=1 %}
{% include image.html filename="japan/06-25.jpeg" r=1 %}
...
{% include image.html filename="japan/06-27.jpeg" l=1 %}
{% include image.html filename="japan/06-28.jpeg" r=1 %}

河中央的船上不知是备了多少烟花。（相机拍摄）

拍了几段视频，效果都一般般，上传了一段最后高潮的，不过视频没有转向，电脑上看可能有点麻烦……

{% include image.html filename="japan/06-29.jpeg" l=1 %}
{% include image.html filename="japan/06-30.jpeg" r=1 %}
