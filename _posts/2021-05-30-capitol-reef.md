...
{% include image.html filename="webp/2021-05/001-01.webp" hf=1 %}
{% include image.html filename="webp/2021-05/001-02.webp" hf=1 %}
...
这条路是沿着山谷的谷底，基本没有海拔变化所以很轻松（下图），但最后要到达the tanks的0.2miles要爬上山还是需要些体力的。我在来之前并不知道所谓tank是指什么，直到我爬着爬着绕过一个沙坑后发现没路了，回头一看，原来这重点的tank就是一个坑啊（下图）……我确实感觉有点坑……在谷歌地图上甚至找不到这个景点。建议如果想走trail的话走到Pioneer Register就可以了。

{% include image.html filename="webp/2021-05/001-03.webp" hf=1 %}
{% include image.html filename="webp/2021-05/001-04.webp" hf=1 %}

下去之后原路返回到了车上，原路驶离公园，路上的风景是另一个角度的壮阔（下图）。

{% include image.html filename="webp/2021-05/001-05.webp" hf=1 %}
{% include image.html filename="webp/2021-05/001-06.webp" hf=1 %}
