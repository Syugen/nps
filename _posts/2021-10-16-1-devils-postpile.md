...
{% include image.html filename="webp/2021-10/025-01.webp" %}

trail可以选择爬上恶魔柱顶端（下图），也可以继续往里可以走到彩虹瀑布。然而我就没有继续，因为这一天的行程还很多。

{% include image.html filename="webp/2021-10/025-02.webp" hf=1 %}
{% include image.html filename="webp/2021-10/025-03.webp" hf=1 %}

下面几张图介绍了这些石柱的形成历史。最神奇的是他们大多裂开成截面为正六边形的柱子，这背后隐藏着物理和数学的美！

{% include image.html filename="webp/2021-10/025-04.webp" hf=1 %}
{% include image.html filename="webp/2021-10/025-05.webp" hf=1 %}
{% include image.html filename="webp/2021-10/025-06.webp" hf=1 %}
