...
{% include image.html filename="webp/2021-10/025-s1.webp" %}
...
{% include image.html filename="webp/2021-10/025-s2.webp" %}

注：这段unpaved road还是在半山腰，在一个转弯处还只能单行，需要点车技和心态。

苹果的图如果不是P的，那需要在Aspen树叶刚变黄时（10月初）突降一场雪。这不是完全不可能但是会很难得。

{% include image.html filename="webp/2021-10/025-s3.webp" %}
...
{% include image.html filename="webp/2021-10/025-s4.webp" %}
