...
{% include image.html filename="webp/2021-10/027-01.webp" hf=1 %}
{% include image.html filename="webp/2021-10/027-03.webp" hf=1 %}

来到Badwater Basin，北美大陆最低点海拔-282英尺（-86米）。

{% include image.html filename="webp/2021-10/027-04.webp" hf=1 %}
{% include image.html filename="webp/2021-10/027-05.webp" hf=1 %}

Zabriskie Point。

{% include image.html filename="webp/2021-10/027-06.webp" %}
...
{% include image.html filename="webp/2021-10/027-02.webp" hf=1 %}
{% include image.html filename="webp/2021-10/027-11.webp" hf=1 %}

我远远望去就看到了一个疑似壁纸的沙堆。

{% include image.html filename="webp/2021-10/027-08.webp" %}

可是我低估了沙堆的高度和数量。翻过每个沙堆大概算是爬两三层楼，到我想要的目的地大概要单程翻10个，而且最后一个陡峭得我手脚并用终于登顶。

{% include image.html filename="webp/2021-10/027-07.webp" hf=1 %}
{% include image.html filename="webp/2021-10/027-09.webp" hf=1 %}

我评估了一番，最后觉得角度还是不对，但也不值得继续往前走了，因为我当时坚信那图就不是这里，而就是合成出来的。于是休息休息开始返程。此时在沙丘最高处能看到停车场，但是却如同旧金山与温哥华一般遥远。

{% include image.html filename="webp/2021-10/027-10.webp" %}
